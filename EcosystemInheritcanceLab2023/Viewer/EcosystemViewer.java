...
public class EcosystemViewer extends Application
{
    ...
    public void start(Stage stage)
    {
        ...
        myCanvas = new Canvas((world.WIDTH) * CREATURE_SIZE, 
            (world.HEIGHT) * CREATURE_SIZE);
    ...
    private void eraseCanvas() {
        ...
        gc.fillRect(0, 0, (world.WIDTH) * CREATURE_SIZE , (world.HEIGHT) * CREATURE_SIZE);
        gc.strokeRect(0, 0, (world.WIDTH) * CREATURE_SIZE , (world.HEIGHT) * CREATURE_SIZE);
    }
